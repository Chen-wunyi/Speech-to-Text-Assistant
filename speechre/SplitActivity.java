...
public class SplitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String DataBaseTable = "SplitTable";
        SQLiteDatabase db ;
        ...
        while (c.moveToNext()) {
            ...
            split = String.valueOf(c.getBlob(1));
        ...
        addBtnS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               //     e.printStackTrace();
                //}
                byte[] editText = new byte[0];
                contentValues.put("split", editText);
        ...
        backBtnS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(SplitActivity.this, MainActivity.class);
